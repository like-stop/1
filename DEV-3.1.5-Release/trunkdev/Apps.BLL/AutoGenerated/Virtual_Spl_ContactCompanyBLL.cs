...
namespace Apps.BLL.Spl
{
	...
	public class Virtual_Spl_ContactCompanyBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<Spl_ContactCompanyModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<Spl_ContactCompanyModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<Spl_ContactCompanyModel>>(pager,list);
        }
		public virtual async Task<List<Spl_ContactCompanyModel>> CreateModelListAsync(IQueryable<Spl_ContactCompany> queryData)
        {

            List<Spl_ContactCompanyModel> modelList = await (from r in queryData
		...
		public virtual List<Spl_ContactCompanyModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<Spl_ContactCompanyModel>();
		}
		...
		public virtual List<Spl_ContactCompanyModel> GetList(string id, string parentId)
        {
			return new List<Spl_ContactCompanyModel>();
		}
        ...
        public virtual bool Edit(ref ValidationErrors errors, Spl_ContactCompanyModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(Spl_ContactCompanyModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
        ...
        public virtual Spl_ContactCompanyModel GetById(object id)
        {
		 ...
		 public virtual async Task<Spl_ContactCompanyModel> GetByIdAsync(object id)
        {
            if (IsExists(id))
            {
                Spl_ContactCompany entity = await m_Rep.GetByIdAsync(id);
                Spl_ContactCompanyModel model = new Spl_ContactCompanyModel();
                              				model.Id = entity.Id;
				model.Code = entity.Code;
				model.Name = entity.Name;

...
namespace Apps.BLL.WC
{
	...
	public class Virtual_WC_MessageResponseBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<WC_MessageResponseModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<WC_MessageResponseModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<WC_MessageResponseModel>>(pager,list);
        }
		public virtual async Task<List<WC_MessageResponseModel>> CreateModelListAsync(IQueryable<WC_MessageResponse> queryData)
        {

            List<WC_MessageResponseModel> modelList = await (from r in queryData
		...
		public virtual List<WC_MessageResponseModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<WC_MessageResponseModel>();
		}
		...
		public virtual List<WC_MessageResponseModel> GetList(string id, string parentId)
        {
			return new List<WC_MessageResponseModel>();
		}
        ...
        public virtual bool Edit(ref ValidationErrors errors, WC_MessageResponseModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(WC_MessageResponseModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {

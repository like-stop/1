...
namespace Apps.BLL.Sys
{
	...
	public class Virtual_SysLogBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<SysLogModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<SysLogModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<SysLogModel>>(pager,list);
        }
		public virtual async Task<List<SysLogModel>> CreateModelListAsync(IQueryable<SysLog> queryData)
        {

            List<SysLogModel> modelList = await (from r in queryData
		...
		public virtual List<SysLogModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<SysLogModel>();
		}
		...
		public virtual List<SysLogModel> GetList(string id, string parentId)
        {
			return new List<SysLogModel>();
		}
        ...
        public virtual bool Create(ref ValidationErrors errors, SysLogModel model)
        {
		 ...
		 public virtual async Task<Tuple<ValidationErrors, bool>> CreateAsync(SysLogModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
                SysLog entity = await m_Rep.GetByIdAsync(model.Id);
                if (entity != null)
                {
                    errors.Add(Resource.PrimaryRepeat);
        ...
        public virtual bool Edit(ref ValidationErrors errors, SysLogModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(SysLogModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
        ...
        public virtual SysLogModel GetById(object id)
        {
		 ...
		 public virtual async Task<SysLogModel> GetByIdAsync(object id)
        {
            if (IsExists(id))
            {
                SysLog entity = await m_Rep.GetByIdAsync(id);
                SysLogModel model = new SysLogModel();
                              				model.Id = entity.Id;
				model.Operator = entity.Operator;
				model.Message = entity.Message;

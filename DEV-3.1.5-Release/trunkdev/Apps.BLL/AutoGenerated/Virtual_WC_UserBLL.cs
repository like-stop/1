...
namespace Apps.BLL.WC
{
	...
	public class Virtual_WC_UserBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<WC_UserModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<WC_UserModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<WC_UserModel>>(pager,list);
        }
		public virtual async Task<List<WC_UserModel>> CreateModelListAsync(IQueryable<WC_User> queryData)
        {

            List<WC_UserModel> modelList = await (from r in queryData
		...
		public virtual List<WC_UserModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<WC_UserModel>();
		}
		...
		public virtual List<WC_UserModel> GetList(string id, string parentId)
        {
			return new List<WC_UserModel>();
		}
        ...
        public virtual bool Edit(ref ValidationErrors errors, WC_UserModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(WC_UserModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {

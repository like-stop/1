...
namespace Apps.BLL.MIS
{
	...
	public class Virtual_MIS_Article_CommentBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<MIS_Article_CommentModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<MIS_Article_CommentModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<MIS_Article_CommentModel>>(pager,list);
        }
		public virtual async Task<List<MIS_Article_CommentModel>> CreateModelListAsync(IQueryable<MIS_Article_Comment> queryData)
        {

            List<MIS_Article_CommentModel> modelList = await (from r in queryData
		...
		public virtual List<MIS_Article_CommentModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<MIS_Article_CommentModel>();
		}
		...
		public virtual List<MIS_Article_CommentModel> GetList(string id, string parentId)
        {
			return new List<MIS_Article_CommentModel>();
		}
        ...
        public virtual bool Edit(ref ValidationErrors errors, MIS_Article_CommentModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(MIS_Article_CommentModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {

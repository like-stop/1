...
namespace Apps.BLL.MIS
{
	...
	public class Virtual_MIS_Article_CategoryBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<MIS_Article_CategoryModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<MIS_Article_CategoryModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<MIS_Article_CategoryModel>>(pager,list);
        }
		public virtual async Task<List<MIS_Article_CategoryModel>> CreateModelListAsync(IQueryable<MIS_Article_Category> queryData)
        {

            List<MIS_Article_CategoryModel> modelList = await (from r in queryData
		...
		public virtual List<MIS_Article_CategoryModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<MIS_Article_CategoryModel>();
		}
		...
		public virtual List<MIS_Article_CategoryModel> GetList(string id, string parentId)
        {
			return new List<MIS_Article_CategoryModel>();
		}
        ...
        public virtual bool Edit(ref ValidationErrors errors, MIS_Article_CategoryModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(MIS_Article_CategoryModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
        ...
        public virtual MIS_Article_CategoryModel GetById(object id)
        {
		 ...
		 public virtual async Task<MIS_Article_CategoryModel> GetByIdAsync(object id)
        {
            if (IsExists(id))
            {
                MIS_Article_Category entity = await m_Rep.GetByIdAsync(id);
                MIS_Article_CategoryModel model = new MIS_Article_CategoryModel();
                              				model.Id = entity.Id;
				model.ChannelId = entity.ChannelId;
				model.Name = entity.Name;

...
namespace Apps.BLL.Sys
{
	...
	public class Virtual_SysRightBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<SysRightModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<SysRightModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<SysRightModel>>(pager,list);
        }
		public virtual async Task<List<SysRightModel>> CreateModelListAsync(IQueryable<SysRight> queryData)
        {

            List<SysRightModel> modelList = await (from r in queryData
		...
		public virtual List<SysRightModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<SysRightModel>();
		}
		...
		public virtual List<SysRightModel> GetList(string id, string parentId)
        {
			return new List<SysRightModel>();
		}

...
namespace Apps.BLL.Spl
{
	...
	public class Virtual_Spl_WareDetailsBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<Spl_WareDetailsModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<Spl_WareDetailsModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<Spl_WareDetailsModel>>(pager,list);
        }
		public virtual async Task<List<Spl_WareDetailsModel>> CreateModelListAsync(IQueryable<Spl_WareDetails> queryData)
        {

            List<Spl_WareDetailsModel> modelList = await (from r in queryData
		...
		public virtual List<Spl_WareDetailsModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<Spl_WareDetailsModel>();
		}
		...
		public virtual List<Spl_WareDetailsModel> GetList(string id, string parentId)
        {
			return new List<Spl_WareDetailsModel>();
		}
        ...
        public virtual bool Create(ref ValidationErrors errors, Spl_WareDetailsModel model)
        {
		 ...
		 public virtual async Task<Tuple<ValidationErrors, bool>> CreateAsync(Spl_WareDetailsModel model)
        {

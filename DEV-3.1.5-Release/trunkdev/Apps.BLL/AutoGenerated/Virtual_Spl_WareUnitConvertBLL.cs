...
namespace Apps.BLL.Spl
{
	...
	public class Virtual_Spl_WareUnitConvertBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<Spl_WareUnitConvertModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<Spl_WareUnitConvertModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<Spl_WareUnitConvertModel>>(pager,list);
        }
		public virtual async Task<List<Spl_WareUnitConvertModel>> CreateModelListAsync(IQueryable<Spl_WareUnitConvert> queryData)
        {

            List<Spl_WareUnitConvertModel> modelList = await (from r in queryData
		...
		public virtual List<Spl_WareUnitConvertModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<Spl_WareUnitConvertModel>();
		}
		...
		public virtual List<Spl_WareUnitConvertModel> GetList(string id, string parentId)
        {
			return new List<Spl_WareUnitConvertModel>();
		}
        ...
        public virtual bool Edit(ref ValidationErrors errors, Spl_WareUnitConvertModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(Spl_WareUnitConvertModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
        ...
        public virtual Spl_WareUnitConvertModel GetById(object id)
        {
		 ...
		 public virtual async Task<Spl_WareUnitConvertModel> GetByIdAsync(object id)
        {
            if (IsExists(id))
            {
                Spl_WareUnitConvert entity = await m_Rep.GetByIdAsync(id);
                Spl_WareUnitConvertModel model = new Spl_WareUnitConvertModel();
                              				model.Id = entity.Id;
				model.Name = entity.Name;
				model.MainUnit = entity.MainUnit;

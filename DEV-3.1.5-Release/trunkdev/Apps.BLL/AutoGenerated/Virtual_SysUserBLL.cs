...
namespace Apps.BLL.Sys
{
	...
	public class Virtual_SysUserBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<SysUserModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<SysUserModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<SysUserModel>>(pager,list);
        }
		public virtual async Task<List<SysUserModel>> CreateModelListAsync(IQueryable<SysUser> queryData)
        {

            List<SysUserModel> modelList = await (from r in queryData
		...
		public virtual List<SysUserModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<SysUserModel>();
		}
		...
		public virtual List<SysUserModel> GetList(string id, string parentId)
        {
			return new List<SysUserModel>();
		}
        ...
        public virtual bool Create(ref ValidationErrors errors, SysUserModel model)
        {
		 ...
		 public virtual async Task<Tuple<ValidationErrors, bool>> CreateAsync(SysUserModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
                SysUser entity = await m_Rep.GetByIdAsync(model.Id);
                if (entity != null)
                {
                    errors.Add(Resource.PrimaryRepeat);
        ...
        public virtual bool Edit(ref ValidationErrors errors, SysUserModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(SysUserModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
        ...
        public virtual SysUserModel GetById(object id)
        {
		 ...
		 public virtual async Task<SysUserModel> GetByIdAsync(object id)
        {
            if (IsExists(id))
            {
                SysUser entity = await m_Rep.GetByIdAsync(id);
                SysUserModel model = new SysUserModel();
                              				model.Id = entity.Id;
				model.UserName = entity.UserName;
				model.Password = entity.Password;

...
namespace Apps.BLL.Sys
{
	...
	public class Virtual_SysRoleBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<SysRoleModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<SysRoleModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<SysRoleModel>>(pager,list);
        }
		public virtual async Task<List<SysRoleModel>> CreateModelListAsync(IQueryable<SysRole> queryData)
        {

            List<SysRoleModel> modelList = await (from r in queryData
		...
		public virtual List<SysRoleModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<SysRoleModel>();
		}
		...
		public virtual List<SysRoleModel> GetList(string id, string parentId)
        {
			return new List<SysRoleModel>();
		}
        ...
        public virtual bool Create(ref ValidationErrors errors, SysRoleModel model)
        {
		 ...
		 public virtual async Task<Tuple<ValidationErrors, bool>> CreateAsync(SysRoleModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
                SysRole entity = await m_Rep.GetByIdAsync(model.Id);
                if (entity != null)
                {
                    errors.Add(Resource.PrimaryRepeat);
        ...
        public virtual bool Edit(ref ValidationErrors errors, SysRoleModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(SysRoleModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
        ...
        public virtual SysRoleModel GetById(object id)
        {
		 ...
		 public virtual async Task<SysRoleModel> GetByIdAsync(object id)
        {
            if (IsExists(id))
            {
                SysRole entity = await m_Rep.GetByIdAsync(id);
                SysRoleModel model = new SysRoleModel();
                              				model.Id = entity.Id;
				model.Name = entity.Name;
				model.Description = entity.Description;

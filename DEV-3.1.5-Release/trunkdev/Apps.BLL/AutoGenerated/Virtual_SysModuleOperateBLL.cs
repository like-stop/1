...
namespace Apps.BLL.Sys
{
	...
	public class Virtual_SysModuleOperateBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<SysModuleOperateModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<SysModuleOperateModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<SysModuleOperateModel>>(pager,list);
        }
		public virtual async Task<List<SysModuleOperateModel>> CreateModelListAsync(IQueryable<SysModuleOperate> queryData)
        {

            List<SysModuleOperateModel> modelList = await (from r in queryData
		...
		public virtual List<SysModuleOperateModel> GetList(ref GridPager pager, string queryStr)
        {
			...
			public virtual List<SysModuleOperateModel> GetListByUserId(ref GridPager pager, string userId,string queryStr)
		{
			return new List<SysModuleOperateModel>();
		}
		public virtual List<SysModuleOperateModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<SysModuleOperateModel>();
		}
		
		public virtual List<SysModuleOperateModel> GetListByParentId(ref GridPager pager, string queryStr,object parentId)
        {
			return new List<SysModuleOperateModel>();
		}
		public virtual List<SysModuleOperateModel> GetList(string id, string parentId)
        {
			return new List<SysModuleOperateModel>();
		}
        ...
        public virtual bool Create(ref ValidationErrors errors, SysModuleOperateModel model)
        {
		 ...
		 public virtual async Task<Tuple<ValidationErrors, bool>> CreateAsync(SysModuleOperateModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
                SysModuleOperate entity = await m_Rep.GetByIdAsync(model.Id);
                if (entity != null)
                {
                    errors.Add(Resource.PrimaryRepeat);
        ...
        public virtual bool Edit(ref ValidationErrors errors, SysModuleOperateModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(SysModuleOperateModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
        ...
        public virtual SysModuleOperateModel GetById(object id)
        {
            if (IsExists(id))
            {

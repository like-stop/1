...
namespace Apps.BLL.Sys
{
	...
	public class Virtual_SysSampleBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<SysSampleModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<SysSampleModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<SysSampleModel>>(pager,list);
        }
		public virtual async Task<List<SysSampleModel>> CreateModelListAsync(IQueryable<SysSample> queryData)
        {

            List<SysSampleModel> modelList = await (from r in queryData
		...
		public virtual List<SysSampleModel> GetList(ref GridPager pager, string queryStr)
        {
			...
			public virtual List<SysSampleModel> GetListByUserId(ref GridPager pager, string userId,string queryStr)
		{
		...
		public virtual List<SysSampleModel> GetListByParentId(ref GridPager pager, string queryStr,object parentId)
        {
			return new List<SysSampleModel>();
		}
		public virtual List<SysSampleModel> GetList(string id, string parentId)
        {
			return new List<SysSampleModel>();
		}
        ...
        public virtual bool Create(ref ValidationErrors errors, SysSampleModel model)
        {
		 ...
		 public virtual async Task<Tuple<ValidationErrors, bool>> CreateAsync(SysSampleModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
                SysSample entity = await m_Rep.GetByIdAsync(model.Id);
                if (entity != null)
                {
                    errors.Add(Resource.PrimaryRepeat);
        ...
        public virtual bool Edit(ref ValidationErrors errors, SysSampleModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(SysSampleModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
        ...
        public virtual SysSampleModel GetById(object id)
        {
            if (IsExists(id))
            {
		 ...
		 public virtual async Task<SysSampleModel> GetByIdAsync(object id)
        {
            if (IsExists(id))
            {
                SysSample entity = await m_Rep.GetByIdAsync(id);
                SysSampleModel model = new SysSampleModel();
                              				model.Id = entity.Id;
				model.Name = entity.Name;
				model.Age = entity.Age;

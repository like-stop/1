...
namespace Apps.BLL.WC
{
	...
	public class Virtual_WC_GroupBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<WC_GroupModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<WC_GroupModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<WC_GroupModel>>(pager,list);
        }
		public virtual async Task<List<WC_GroupModel>> CreateModelListAsync(IQueryable<WC_Group> queryData)
        {

            List<WC_GroupModel> modelList = await (from r in queryData
		...
		public virtual List<WC_GroupModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<WC_GroupModel>();
		}
		...
		public virtual List<WC_GroupModel> GetList(string id, string parentId)
        {
			return new List<WC_GroupModel>();
		}
        ...
        public virtual WC_GroupModel GetById(object id)
        {
		 ...
		 public virtual async Task<WC_GroupModel> GetByIdAsync(object id)
        {
            if (IsExists(id))
            {
                WC_Group entity = await m_Rep.GetByIdAsync(id);
                WC_GroupModel model = new WC_GroupModel();
                              				model.Id = entity.Id;
				model.Name = entity.Name;
				model.Count = entity.Count;

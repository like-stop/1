...
namespace Apps.BLL.MIS
{
	...
	public class Virtual_MIS_WebIM_Message_RecBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<MIS_WebIM_Message_RecModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<MIS_WebIM_Message_RecModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<MIS_WebIM_Message_RecModel>>(pager,list);
        }
		public virtual async Task<List<MIS_WebIM_Message_RecModel>> CreateModelListAsync(IQueryable<MIS_WebIM_Message_Rec> queryData)
        {

            List<MIS_WebIM_Message_RecModel> modelList = await (from r in queryData
		...
		public virtual List<MIS_WebIM_Message_RecModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<MIS_WebIM_Message_RecModel>();
		}
		...
		public virtual List<MIS_WebIM_Message_RecModel> GetList(string id, string parentId)
        {
			return new List<MIS_WebIM_Message_RecModel>();
		}
        ...
        public virtual MIS_WebIM_Message_RecModel GetById(object id)
        {
		 ...
		 public virtual async Task<MIS_WebIM_Message_RecModel> GetByIdAsync(object id)
        {
            if (IsExists(id))
            {
                MIS_WebIM_Message_Rec entity = await m_Rep.GetByIdAsync(id);
                MIS_WebIM_Message_RecModel model = new MIS_WebIM_Message_RecModel();
                              				model.MessageId = entity.MessageId;
				model.receiver = entity.receiver;
				model.State = entity.State;

...
namespace Apps.BLL.Spl
{
	...
	public class Virtual_Spl_ContactCompanyCategoryBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<Spl_ContactCompanyCategoryModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<Spl_ContactCompanyCategoryModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<Spl_ContactCompanyCategoryModel>>(pager,list);
        }
		public virtual async Task<List<Spl_ContactCompanyCategoryModel>> CreateModelListAsync(IQueryable<Spl_ContactCompanyCategory> queryData)
        {

            List<Spl_ContactCompanyCategoryModel> modelList = await (from r in queryData
		...
		public virtual List<Spl_ContactCompanyCategoryModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<Spl_ContactCompanyCategoryModel>();
		}
		...
		public virtual List<Spl_ContactCompanyCategoryModel> GetList(string id, string parentId)
        {
			return new List<Spl_ContactCompanyCategoryModel>();
		}
        ...
        public virtual bool Create(ref ValidationErrors errors, Spl_ContactCompanyCategoryModel model)
        {
		 ...
		 public virtual async Task<Tuple<ValidationErrors, bool>> CreateAsync(Spl_ContactCompanyCategoryModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
                Spl_ContactCompanyCategory entity = await m_Rep.GetByIdAsync(model.Id);
                if (entity != null)
                {
                    errors.Add(Resource.PrimaryRepeat);
        ...
        public virtual bool Edit(ref ValidationErrors errors, Spl_ContactCompanyCategoryModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(Spl_ContactCompanyCategoryModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
        ...
        public virtual Spl_ContactCompanyCategoryModel GetById(object id)
        {
		 ...
		 public virtual async Task<Spl_ContactCompanyCategoryModel> GetByIdAsync(object id)
        {
            if (IsExists(id))
            {
                Spl_ContactCompanyCategory entity = await m_Rep.GetByIdAsync(id);
                Spl_ContactCompanyCategoryModel model = new Spl_ContactCompanyCategoryModel();
                              				model.Id = entity.Id;
				model.Name = entity.Name;
				model.CreateTime = entity.CreateTime;

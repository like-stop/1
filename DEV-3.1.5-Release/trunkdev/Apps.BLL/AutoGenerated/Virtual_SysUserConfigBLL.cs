...
namespace Apps.BLL.Sys
{
	...
	public class Virtual_SysUserConfigBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<SysUserConfigModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<SysUserConfigModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<SysUserConfigModel>>(pager,list);
        }
		public virtual async Task<List<SysUserConfigModel>> CreateModelListAsync(IQueryable<SysUserConfig> queryData)
        {

            List<SysUserConfigModel> modelList = await (from r in queryData
		...
		public virtual List<SysUserConfigModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<SysUserConfigModel>();
		}
		...
		public virtual List<SysUserConfigModel> GetList(string id, string parentId)
        {
			return new List<SysUserConfigModel>();
		}
        ...
        public virtual bool Edit(ref ValidationErrors errors, SysUserConfigModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(SysUserConfigModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {

...
namespace Apps.BLL.Flow
{
	...
	public class Virtual_Flow_StepRuleBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<Flow_StepRuleModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<Flow_StepRuleModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<Flow_StepRuleModel>>(pager,list);
        }
		public virtual async Task<List<Flow_StepRuleModel>> CreateModelListAsync(IQueryable<Flow_StepRule> queryData)
        {

            List<Flow_StepRuleModel> modelList = await (from r in queryData
		...
		public virtual List<Flow_StepRuleModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<Flow_StepRuleModel>();
		}
		...
		public virtual List<Flow_StepRuleModel> GetList(string id, string parentId)
        {
			return new List<Flow_StepRuleModel>();
		}
        ...
        public virtual bool Create(ref ValidationErrors errors, Flow_StepRuleModel model)
        {
		 ...
		 public virtual async Task<Tuple<ValidationErrors, bool>> CreateAsync(Flow_StepRuleModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
                Flow_StepRule entity = await m_Rep.GetByIdAsync(model.Id);
                if (entity != null)
                {
                    errors.Add(Resource.PrimaryRepeat);
        ...
        public virtual bool Edit(ref ValidationErrors errors, Flow_StepRuleModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(Flow_StepRuleModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
        ...
        public virtual Flow_StepRuleModel GetById(object id)
        {
		 ...
		 public virtual async Task<Flow_StepRuleModel> GetByIdAsync(object id)
        {
            if (IsExists(id))
            {
                Flow_StepRule entity = await m_Rep.GetByIdAsync(id);
                Flow_StepRuleModel model = new Flow_StepRuleModel();
                              				model.Id = entity.Id;
				model.StepId = entity.StepId;
				model.AttrId = entity.AttrId;

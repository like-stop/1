...
namespace Apps.BLL.MIS
{
	...
	public class Virtual_MIS_ArticleBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<MIS_ArticleModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<MIS_ArticleModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<MIS_ArticleModel>>(pager,list);
        }
		public virtual async Task<List<MIS_ArticleModel>> CreateModelListAsync(IQueryable<MIS_Article> queryData)
        {

            List<MIS_ArticleModel> modelList = await (from r in queryData
		...
		public virtual List<MIS_ArticleModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<MIS_ArticleModel>();
		}
		...
		public virtual List<MIS_ArticleModel> GetList(string id, string parentId)
        {
			return new List<MIS_ArticleModel>();
		}
        ...
        public virtual bool Edit(ref ValidationErrors errors, MIS_ArticleModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(MIS_ArticleModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {

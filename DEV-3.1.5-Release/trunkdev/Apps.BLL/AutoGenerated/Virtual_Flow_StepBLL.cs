...
namespace Apps.BLL.Flow
{
	...
	public class Virtual_Flow_StepBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<Flow_StepModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<Flow_StepModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<Flow_StepModel>>(pager,list);
        }
		public virtual async Task<List<Flow_StepModel>> CreateModelListAsync(IQueryable<Flow_Step> queryData)
        {

            List<Flow_StepModel> modelList = await (from r in queryData
		...
		public virtual List<Flow_StepModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<Flow_StepModel>();
		}
		...
		public virtual List<Flow_StepModel> GetList(string id, string parentId)
        {
			return new List<Flow_StepModel>();
		}
        ...
        public virtual bool Edit(ref ValidationErrors errors, Flow_StepModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(Flow_StepModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {

...
namespace Apps.BLL.Spl
{
	...
	public class Virtual_Spl_WarehouseBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<Spl_WarehouseModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<Spl_WarehouseModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<Spl_WarehouseModel>>(pager,list);
        }
		public virtual async Task<List<Spl_WarehouseModel>> CreateModelListAsync(IQueryable<Spl_Warehouse> queryData)
        {

            List<Spl_WarehouseModel> modelList = await (from r in queryData
		...
		public virtual List<Spl_WarehouseModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<Spl_WarehouseModel>();
		}
		...
		public virtual List<Spl_WarehouseModel> GetList(string id, string parentId)
        {
			return new List<Spl_WarehouseModel>();
		}
        ...
        public virtual bool Edit(ref ValidationErrors errors, Spl_WarehouseModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(Spl_WarehouseModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {

...
namespace Apps.BLL.Spl
{
	...
	public class Virtual_Spl_PersonBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<Spl_PersonModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<Spl_PersonModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<Spl_PersonModel>>(pager,list);
        }
		public virtual async Task<List<Spl_PersonModel>> CreateModelListAsync(IQueryable<Spl_Person> queryData)
        {

            List<Spl_PersonModel> modelList = await (from r in queryData
		...
		public virtual List<Spl_PersonModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<Spl_PersonModel>();
		}
		...
		public virtual List<Spl_PersonModel> GetList(string id, string parentId)
        {
			return new List<Spl_PersonModel>();
		}
        ...
        public virtual bool Edit(ref ValidationErrors errors, Spl_PersonModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(Spl_PersonModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {

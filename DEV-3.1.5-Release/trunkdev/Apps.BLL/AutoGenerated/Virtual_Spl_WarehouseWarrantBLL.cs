...
{
	public partial class Spl_WarehouseWarrantBLL: Virtual_Spl_WarehouseWarrantBLL,ISpl_WarehouseWarrantBLL
	{
        

	}
	public class Virtual_Spl_WarehouseWarrantBLL
	{
        [Dependency]
        public ISpl_WarehouseWarrantRepository m_Rep { get; set; }
		...
		public virtual async Task<Tuple<GridPager,List<Spl_WarehouseWarrantModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<Spl_WarehouseWarrantModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<Spl_WarehouseWarrantModel>>(pager,list);
        }
		public virtual async Task<List<Spl_WarehouseWarrantModel>> CreateModelListAsync(IQueryable<Spl_WarehouseWarrant> queryData)
        {

            List<Spl_WarehouseWarrantModel> modelList = await (from r in queryData
		...
		public virtual List<Spl_WarehouseWarrantModel> GetList(ref GridPager pager, string queryStr)
        {
		...
		public virtual List<Spl_WarehouseWarrantModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<Spl_WarehouseWarrantModel>();
		}
		...
		public virtual List<Spl_WarehouseWarrantModel> GetList(string id, string parentId)
        {
			return new List<Spl_WarehouseWarrantModel>();
		}
        public virtual List<Spl_WarehouseWarrantModel> CreateModelList(ref IQueryable<Spl_WarehouseWarrant> queryData)
        {
        ...
        public virtual bool Edit(ref ValidationErrors errors, Spl_WarehouseWarrantModel model)
        {
            try
            {
                Spl_WarehouseWarrant entity = m_Rep.GetById(model.Id);
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(Spl_WarehouseWarrantModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
        ...
        public virtual Spl_WarehouseWarrantModel GetById(object id)
        {
		 ...
		 public virtual async Task<Spl_WarehouseWarrantModel> GetByIdAsync(object id)
        {
            if (IsExists(id))
            {
                Spl_WarehouseWarrant entity = await m_Rep.GetByIdAsync(id);
                Spl_WarehouseWarrantModel model = new Spl_WarehouseWarrantModel();
                              				model.Id = entity.Id;
				model.InTime = entity.InTime;
				model.Handler = entity.Handler;
        ...
        /// 保存数据
        /// </summary>
        public virtual void SaveImportData(IEnumerable<Spl_WarehouseWarrantModel> list)
        {
            try
            {
                using (DBContainer db = new DBContainer())
                {
                    foreach (var model in list)
                    {
                        ...
                        db.Spl_WarehouseWarrant.Add(entity);
                    }
                    db.SaveChanges();
                }
            }

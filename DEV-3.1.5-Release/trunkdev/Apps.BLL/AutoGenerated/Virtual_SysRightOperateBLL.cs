...
namespace Apps.BLL.Sys
{
	...
	public class Virtual_SysRightOperateBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<SysRightOperateModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<SysRightOperateModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<SysRightOperateModel>>(pager,list);
        }
		public virtual async Task<List<SysRightOperateModel>> CreateModelListAsync(IQueryable<SysRightOperate> queryData)
        {

            List<SysRightOperateModel> modelList = await (from r in queryData
		...
		public virtual List<SysRightOperateModel> GetList(ref GridPager pager, string queryStr)
        {
			...
			public virtual List<SysRightOperateModel> GetListByUserId(ref GridPager pager, string userId,string queryStr)
		{
			return new List<SysRightOperateModel>();
		}
		public virtual List<SysRightOperateModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<SysRightOperateModel>();
		}
		
		public virtual List<SysRightOperateModel> GetListByParentId(ref GridPager pager, string queryStr,object parentId)
        {
			return new List<SysRightOperateModel>();
		}
		public virtual List<SysRightOperateModel> GetList(string id, string parentId)
        {
			return new List<SysRightOperateModel>();
		}
        ...
        public virtual SysRightOperateModel GetById(object id)
        {
		 ...
		 public virtual async Task<SysRightOperateModel> GetByIdAsync(object id)
        {
            if (IsExists(id))
            {
                SysRightOperate entity = await m_Rep.GetByIdAsync(id);
                SysRightOperateModel model = new SysRightOperateModel();
                              				model.Id = entity.Id;
				model.RightId = entity.RightId;
				model.KeyCode = entity.KeyCode;
        ...
        /// </summary>
        public virtual bool CheckImportData(string fileName, List<SysRightOperateModel> list,ref ValidationErrors errors )
        {
            ...
            foreach (var row in excelContent)
            {
                ...
                var entity = new SysRightOperateModel();
						 				  entity.Id = row.Id;

...
namespace Apps.BLL.Flow
{
	...
	public class Virtual_Flow_FormBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<Flow_FormModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<Flow_FormModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<Flow_FormModel>>(pager,list);
        }
		public virtual async Task<List<Flow_FormModel>> CreateModelListAsync(IQueryable<Flow_Form> queryData)
        {

            List<Flow_FormModel> modelList = await (from r in queryData
		...
		public virtual List<Flow_FormModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<Flow_FormModel>();
		}
		...
		public virtual List<Flow_FormModel> GetList(string id, string parentId)
        {
			return new List<Flow_FormModel>();
		}
        ...
        public virtual bool Create(ref ValidationErrors errors, Flow_FormModel model)
        {
		 ...
		 public virtual async Task<Tuple<ValidationErrors, bool>> CreateAsync(Flow_FormModel model)
        {

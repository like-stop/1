...
namespace Apps.BLL.Sys
{
	...
	public class Virtual_SysStructBLL
	{
		...
		public virtual async Task<List<SysStructModel>> CreateModelListAsync(IQueryable<SysStruct> queryData)
        {

            List<SysStructModel> modelList = await (from r in queryData
		...
		public virtual List<SysStructModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<SysStructModel>();
		}
		...
		public virtual List<SysStructModel> GetList(string id, string parentId)
        {
			return new List<SysStructModel>();
		}
        ...
        public virtual bool Edit(ref ValidationErrors errors, SysStructModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(SysStructModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {

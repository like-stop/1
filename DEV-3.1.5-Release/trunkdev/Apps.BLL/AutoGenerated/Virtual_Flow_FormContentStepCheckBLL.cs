...
namespace Apps.BLL.Flow
{
	...
	public class Virtual_Flow_FormContentStepCheckBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<Flow_FormContentStepCheckModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<Flow_FormContentStepCheckModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<Flow_FormContentStepCheckModel>>(pager,list);
        }
		public virtual async Task<List<Flow_FormContentStepCheckModel>> CreateModelListAsync(IQueryable<Flow_FormContentStepCheck> queryData)
        {

            List<Flow_FormContentStepCheckModel> modelList = await (from r in queryData
		...
		public virtual List<Flow_FormContentStepCheckModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<Flow_FormContentStepCheckModel>();
		}
		...
		public virtual List<Flow_FormContentStepCheckModel> GetList(string id, string parentId)
        {
			return new List<Flow_FormContentStepCheckModel>();
		}
        ...
        public virtual bool Edit(ref ValidationErrors errors, Flow_FormContentStepCheckModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(Flow_FormContentStepCheckModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
        ...
        public virtual Flow_FormContentStepCheckModel GetById(object id)
        {
		 ...
		 public virtual async Task<Flow_FormContentStepCheckModel> GetByIdAsync(object id)
        {
            if (IsExists(id))
            {
                Flow_FormContentStepCheck entity = await m_Rep.GetByIdAsync(id);
                Flow_FormContentStepCheckModel model = new Flow_FormContentStepCheckModel();
                              				model.Id = entity.Id;
				model.ContentId = entity.ContentId;
				model.StepId = entity.StepId;

...
namespace Apps.BLL.MIS
{
	...
	public class Virtual_MIS_WebIM_RecentContactBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<MIS_WebIM_RecentContactModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<MIS_WebIM_RecentContactModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<MIS_WebIM_RecentContactModel>>(pager,list);
        }
		public virtual async Task<List<MIS_WebIM_RecentContactModel>> CreateModelListAsync(IQueryable<MIS_WebIM_RecentContact> queryData)
        {

            List<MIS_WebIM_RecentContactModel> modelList = await (from r in queryData
		...
		public virtual List<MIS_WebIM_RecentContactModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<MIS_WebIM_RecentContactModel>();
		}
		...
		public virtual List<MIS_WebIM_RecentContactModel> GetList(string id, string parentId)
        {
			return new List<MIS_WebIM_RecentContactModel>();
		}
        ...
        public virtual bool Edit(ref ValidationErrors errors, MIS_WebIM_RecentContactModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(MIS_WebIM_RecentContactModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
        ...
        public virtual MIS_WebIM_RecentContactModel GetById(object id)
        {
		 ...
		 public virtual async Task<MIS_WebIM_RecentContactModel> GetByIdAsync(object id)
        {
            if (IsExists(id))
            {
                MIS_WebIM_RecentContact entity = await m_Rep.GetByIdAsync(id);
                MIS_WebIM_RecentContactModel model = new MIS_WebIM_RecentContactModel();
                              				model.Id = entity.Id;
				model.ContactPersons = entity.ContactPersons;
				model.UserId = entity.UserId;

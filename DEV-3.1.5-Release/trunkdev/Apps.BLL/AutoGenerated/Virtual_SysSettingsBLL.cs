...
namespace Apps.BLL.Sys
{
	...
	public class Virtual_SysSettingsBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<SysSettingsModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<SysSettingsModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<SysSettingsModel>>(pager,list);
        }
		public virtual async Task<List<SysSettingsModel>> CreateModelListAsync(IQueryable<SysSettings> queryData)
        {

            List<SysSettingsModel> modelList = await (from r in queryData
		...
		public virtual List<SysSettingsModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<SysSettingsModel>();
		}
		...
		public virtual List<SysSettingsModel> GetList(string id, string parentId)
        {
			return new List<SysSettingsModel>();
		}
        ...
        public virtual bool Create(ref ValidationErrors errors, SysSettingsModel model)
        {
		 ...
		 public virtual async Task<Tuple<ValidationErrors, bool>> CreateAsync(SysSettingsModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
                SysSettings entity = await m_Rep.GetByIdAsync(model.Id);
                if (entity != null)
                {
                    errors.Add(Resource.PrimaryRepeat);
        ...
        public virtual bool Edit(ref ValidationErrors errors, SysSettingsModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(SysSettingsModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
        ...
        public virtual SysSettingsModel GetById(object id)
        {
		 ...
		 public virtual async Task<SysSettingsModel> GetByIdAsync(object id)
        {
            if (IsExists(id))
            {
                SysSettings entity = await m_Rep.GetByIdAsync(id);
                SysSettingsModel model = new SysSettingsModel();
                              				model.Id = entity.Id;
				model.Name = entity.Name;
				model.Type = entity.Type;

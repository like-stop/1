...
namespace Apps.BLL.Flow
{
	...
	public class Virtual_Flow_FormContentBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<Flow_FormContentModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<Flow_FormContentModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<Flow_FormContentModel>>(pager,list);
        }
		public virtual async Task<List<Flow_FormContentModel>> CreateModelListAsync(IQueryable<Flow_FormContent> queryData)
        {

            List<Flow_FormContentModel> modelList = await (from r in queryData
		...
		public virtual List<Flow_FormContentModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<Flow_FormContentModel>();
		}
		...
		public virtual List<Flow_FormContentModel> GetList(string id, string parentId)
        {
			return new List<Flow_FormContentModel>();
		}
        ...
        public virtual bool Create(ref ValidationErrors errors, Flow_FormContentModel model)
        {
		 ...
		 public virtual async Task<Tuple<ValidationErrors, bool>> CreateAsync(Flow_FormContentModel model)
        {

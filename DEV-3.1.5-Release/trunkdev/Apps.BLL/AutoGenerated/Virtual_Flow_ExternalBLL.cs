...
namespace Apps.BLL.Flow
{
	...
	public class Virtual_Flow_ExternalBLL
	{
		...
		public virtual async Task<Tuple<GridPager,List<Flow_ExternalModel>>> GetListAsync(GridPager pager, string queryStr)
        {
            ...
            List<Flow_ExternalModel> list = await CreateModelListAsync(queryData);
            return  new Tuple<GridPager,List<Flow_ExternalModel>>(pager,list);
        }
		public virtual async Task<List<Flow_ExternalModel>> CreateModelListAsync(IQueryable<Flow_External> queryData)
        {

            List<Flow_ExternalModel> modelList = await (from r in queryData
		...
		public virtual List<Flow_ExternalModel> GetListByDepId(ref GridPager pager, string depId,string queryStr)
		{
			return new List<Flow_ExternalModel>();
		}
		...
		public virtual List<Flow_ExternalModel> GetList(string id, string parentId)
        {
			return new List<Flow_ExternalModel>();
		}
        ...
        public virtual bool Create(ref ValidationErrors errors, Flow_ExternalModel model)
        {
		 ...
		 public virtual async Task<Tuple<ValidationErrors, bool>> CreateAsync(Flow_ExternalModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
                Flow_External entity = await m_Rep.GetByIdAsync(model.Id);
                if (entity != null)
                {
                    errors.Add(Resource.PrimaryRepeat);
        ...
        public virtual bool Edit(ref ValidationErrors errors, Flow_ExternalModel model)
        {
      	 ...
      	 public virtual async Task<Tuple<ValidationErrors, bool>> EditAsync(Flow_ExternalModel model)
        {
			ValidationErrors errors = new ValidationErrors();
            try
            {
        ...
        public virtual Flow_ExternalModel GetById(object id)
        {
		 ...
		 public virtual async Task<Flow_ExternalModel> GetByIdAsync(object id)
        {
            if (IsExists(id))
            {
                Flow_External entity = await m_Rep.GetByIdAsync(id);
                Flow_ExternalModel model = new Flow_ExternalModel();
                              				model.Id = entity.Id;
				model.Title = entity.Title;
				model.Remark = entity.Remark;

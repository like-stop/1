...
namespace Apps.Web
{
    public class SqlHelper
    {
        ...
        public static string connection = ConfigPara.QuartzDBConnection;
        public static string ExecteSqlGetValue(string sql)
        {
        ...
        public static List<TableModel> GetAllTableName()
        {
            List<TableModel> dic = new List<TableModel>();
        ...
        public static List<TableModel> GetAllTreeTableName()
        {
            List<TableModel> dic = new List<TableModel>();
            string cmdStirng = @"SELECT objs.name
FROM syscolumns cols inner join sysobjects objs on cols.id = objs.id and objs.xtype = 'U' and objs.name <> 'dtproperties'
left join sys.extended_properties props on cols.id = props.major_id and cols.colid = props.minor_id
inner join systypes c on cols.xtype = c.xusertype where cols.name = 'parentId' order by objs.name";
            SqlConnection connect = new SqlConnection(connection);
            SqlCommand cmd = new SqlCommand(cmdStirng, connect);
            try
            {
        ...
        /// <returns></returns>
        public static List<string> GetColumnField(string TableName)
        {
        ...
        public static List<CompleteField> GetColumnCompleteField(string TableName)
        {

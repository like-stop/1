...
namespace Apps.Web.Controllers
{
    public class SysCalendarPlanController : BaseController
    {
        ...
        [HttpPost]
        //[SupportFilter]
        public JsonResult Create(string Id, string Title, string PlanContent, DateTime BeginDate, DateTime EndDate, DateTime CreateTime, string Url, string Color, string TextColor, string SysUserId, string Editable)
        {
            SysCalendarPlanModel model = new SysCalendarPlanModel();
            model.Id = ResultHelper.NewId;
            model.CreateTime = ResultHelper.NowTime;
            model.SysUserId = GetUserId();
            model.Editable = Editable == null ? "false" : Editable;
            model.PlanContent = PlanContent;
        ...
        [HttpPost]
        //[SupportFilter]
        public JsonResult Edit(string Id, string Title, string PlanContent, DateTime BeginDate, DateTime EndDate, DateTime CreateTime, string Url, string Color, string TextColor, string SysUserId, string Editable)
        {

            SysCalendarPlanModel model = m_BLL.GetById(Id);
